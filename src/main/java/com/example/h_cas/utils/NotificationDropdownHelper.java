    ...
    private void navigateToCreatePrescription(Patient patient, String notificationId) {
        ...
        if (firebaseRTDBHelper != null) {
            firebaseRTDBHelper.getPatientById(patient.getPatientId(), firebasePatient -> {
                ...
                try {
                    if (context instanceof com.example.h_cas.DoctorDashboardActivity) {
                        com.example.h_cas.DoctorDashboardActivity activity = (com.example.h_cas.DoctorDashboardActivity) context;
                        com.example.h_cas.CreatePrescriptionFragment prescriptionFragment = new com.example.h_cas.CreatePrescriptionFragment();
        ...
        if (firebaseRTDBHelper != null) {
            firebaseRTDBHelper.getPatientById(patient.getPatientId(), firebasePatient -> {
                ...
                try {
                    if (context instanceof com.example.h_cas.DoctorDashboardActivity) {
                        com.example.h_cas.DoctorDashboardActivity activity = (com.example.h_cas.DoctorDashboardActivity) context;
                        com.example.h_cas.CreateDiagnosisFragment diagnosisFragment = new com.example.h_cas.CreateDiagnosisFragment();
