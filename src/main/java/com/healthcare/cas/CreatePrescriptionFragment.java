...
import com.healthcare.cas.adapters.MedicationPrescriptionAdapter;
import com.healthcare.cas.database.HCasDatabaseHelper;
import com.healthcare.cas.database.FirebaseRTDBHelper;
import com.healthcare.cas.models.MedicationItem;
...
import com.healthcare.cas.utils.RFIDHelper;
...
public class CreatePrescriptionFragment extends Fragment {
    ...
    private void getPatientName(String patientId, PatientNameCallback callback) {
        ...
        if (firebaseRTDBHelper != null) {
            firebaseRTDBHelper.getPatientById(patientId, patient -> {
                if (patient != null) {
                    ...
                    if (databaseHelper != null) {
                        com.healthcare.cas.models.Patient sqlitePatient = databaseHelper.getPatientById(patientId);
            ...
            if (databaseHelper != null) {
                com.healthcare.cas.models.Patient patient = databaseHelper.getPatientById(patientId);
                if (patient != null) {
                    String fullName = patient.getFirstName() + " " + patient.getLastName();
                    if (callback != null) callback.onResult(fullName);
                } else {
