...
import com.healthcare.cas.models.Medicine;
...
public class PharmacistDashboardActivity extends AppCompatActivity {
    ...
    private void loadNotifications() {
        ...
        com.healthcare.cas.utils.DatabaseExecutor.getInstance().execute(() -> {
            try {
                // Get all medicines
                List<com.healthcare.cas.models.Medicine> allMedicines = databaseHelper != null ? 
                    databaseHelper.getAllMedicines() : new java.util.ArrayList<>();
                
                // Filter expired and expiring medicines
                java.util.List<com.healthcare.cas.models.Medicine> expiredMedicines = new java.util.ArrayList<>();
                java.util.List<com.healthcare.cas.models.Medicine> expiringMedicines = new java.util.ArrayList<>();
                ...
                for (com.healthcare.cas.models.Medicine medicine : allMedicines) {
                ...
                for (com.healthcare.cas.models.Medicine medicine : expiredMedicines) {
                ...
                for (com.healthcare.cas.models.Medicine medicine : expiringMedicines) {
